...
namespace SistemsProyect.Model.DataBase.Controllers
{
    ...
    {
        private static Singleton _singleton = Singleton.GetInstance();
        ...
        internal static void GetUser(string email, string password)
        {
            ...
            using (MySqlCommand sqlCommand = new MySqlCommand(_instruction, _singleton.GetConnection()))
            {
